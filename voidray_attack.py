...
2020/06/25T16:52:开始尝试实现两块 8bg 提速叉一波
2020/06/25T20:40:完成八兵营提速叉一波；下一步想要实现：两矿追猎叉子一波
2020/05/25T22:16:追猎叉子压制编写完成；下一步目标：实现折跃门刷兵
2020/06/26T11:25:折跃门刷兵完成
2020/06/26T13:22:准备（1）解决：如果一波打不进去ai如何能够回家攒兵再打（2）编写两不朽一波的战术
2020/06/26T22:14:先写了一个造vr和ob的函数
2020/06/27T14:00:加了开三基地后bf升攻防的函数
2020/06/27T14:05:开始写基地给加速的函数
2020/06/27T14:05:完成了基地加速兵营、加速bf升级的功能，写了一个憋憋乐进攻的方法
2020/06/27T17:00:下一步目标：写出更合适、更科学的侦察和进攻方法 希望找到做建筑学的方法
2020/06/27T22:20:先写一个造vb和出巨像的函数吧
2020/06/29T22:50:开始准备编写进攻和防守的函数，顺便：写几个vs科技路线的函数、研究一下blink是怎么跳的并把这个加入到我的ai中（希望在7月三号之前完成这些工作吧
增加的任務：研究可視化和神經網絡相關内容
2020/07/01T23:00:完成ob侦察的函数，完成vs和造虚空的函数
2020/07/02T23:00:重写的进攻防守函数完成，但是还是有点问题，有点不太聪明的亚子
注：此处的8bg有时会多补或者少补一个
"""
import sc2
